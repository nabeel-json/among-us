...
<div class="flex justify-center items-center md:py-16 py-10 text-balance">
    <div class="flex justify-center items-center flex-col gap-6 w-[min(600px,90%)] text-center">
